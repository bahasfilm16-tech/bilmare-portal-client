...
import {
  ...
  CheckCircle2, Clock, Filter, Loader2, X, Trash2
} from 'lucide-react';
...
export const DocumentVault = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      // 1. Hapus file dari Storage kalau ada
  ...
  const handleDownload = async (doc: DocRow) => {
    if (!doc.filePath) {
      addToast('File tidak tersedia untuk diunduh.', 'error');
      return;
    }
          ...
          <Card>
            {loading ? (
              ...
              <div className="text-center py-16 text-slate-400">
                ...
                <p className="text-sm mt-1">Klik "Upload Document" untuk mengunggah.</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
                    ...
                    <React.Fragment key={doc.id}>
                      ...
                      {doc.status === 'Needs Clarification' && doc.clarification && (
                        <TableRow className="bg-red-50/30 border-t-0">
                          <TableCell colSpan={5} className="pt-0 pb-4 pl-14">
                            <div className="bg-white border border-red-100 rounded-lg p-4 shadow-sm">
                              ...
                              <div className="flex gap-2">
                                ...
                                />
                                <Button size="sm">Kirim Respons</Button>
                              </div>
                            </div>
                          </TableCell>
                        </TableRow>
            ...
            <form onSubmit={handleUpload} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ref={fileInputRef}
                  type="file"
                  accept=".pdf,.xlsx,.xls,.docx,.doc,.pptx,.csv"
